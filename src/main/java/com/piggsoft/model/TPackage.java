...
public class TPackage {
    ...
    @Column(name = "over_discount")
    private BigDecimal overDiscount;
    ...
    /**
     * @return over_discount
     */
    public BigDecimal getOverDiscount() {
        return overDiscount;
    }
     ...
     * @param overDiscount
     */
    public void setOverDiscount(BigDecimal overDiscount) {
